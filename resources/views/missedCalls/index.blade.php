...
@section('content')
    ...
    @foreach($missedCalls as $missedCall)
        <div class="card bg-gray" style="margin-top: .5rem; margin-left: 1rem; margin-right: 2rem; margin-bottom: .5rem">
        <a href="{{route('missedCalls.show', $missedCall->id)}}" style="margin: 1rem">
            <p>
